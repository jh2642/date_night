...
app.get('/api/v1/search', function (request, response) {
    https.get('https://maps.googleapis.com/maps/api/place/textsearch/json?query=' + request.query.typeSearch + '&location=' + request.query.location + '&radius=16094' + '&key=' + process.env.GOOGLE_PLACES_KEY,
